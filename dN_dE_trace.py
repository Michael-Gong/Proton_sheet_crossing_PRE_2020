...
if __name__ == "__main__":
  ...
  for n in range(start,stop+step,step):
    ...
    header=data['Header']
    time=header['time']
    print('reading',from_path+'trace'+str(n).zfill(4)+".sdf")
    
    plt.subplot(3,1,1)
    function_plot_dN_dE(data=data,name='subset_trace_p/t_carbon',mass=1836.*12.,linecolor='limegreen')
    function_plot_dN_dE(data=data,name='subset_trace_p/t_electron',mass=1.,linecolor='blue')
    function_plot_dN_dE(data=data,name='subset_trace_p/t_proton',mass=1836.,linecolor='red')
...
#    plt.ylim(1e1,1e5)
    ...
    plt.subplot(3,1,2)
    function_bar_work_frac(data=data,name='subset_trace_p/t_electron',mass=1.)
    plt.xlim(-10,510)
    plt.ylim(0,103)
...
#plt.text(200,650,' t=400fs',fontdict=font)
    ...
    plt.subplot(3,1,3)
    function_bar_work_frac(data=data,name='subset_trace_p/t_proton',mass=1836.)
    plt.xlim(-10,510)
    plt.ylim(0,103)
