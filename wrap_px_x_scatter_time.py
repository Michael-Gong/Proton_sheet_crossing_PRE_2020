...
if __name__ == '__main__':
  ...
  part13_id = part13_id[abs(grid_y)<2]
...
#  ax2 = ax1.twinx()
  ...
  for i in range(5):
      ...
      img = ax1.scatter(grid_x, px, c=time_c, norm=colors.Normalize(vmin=20, vmax=220), cmap=colors.ListedColormap(serial_color), s=0.005, edgecolors='None', alpha=0.66)
