...
if __name__ == '__main__':
  ...
  for n in range(start,stop+step,step):   
      ...
      if 'Grid/Particles/subset_trace_p/t_electron' in data.keys():
          ion_x = data['Grid/Particles/subset_trace_p/t_electron'].data[0]/1e-6
          ion_px = data['Particles/Px/subset_trace_p/t_electron'].data/(1000*m0*v0)
      ...
      if 'Grid/Particles/subset_trace_p/t_carbon' in data.keys():
          ion_x = data['Grid/Particles/subset_trace_p/t_carbon'].data[0]/1e-6
          ion_px = data['Particles/Px/subset_trace_p/t_carbon'].data/(12.0*1836*m0*v0)
      ...
      if 'Grid/Particles/subset_trace_p/t_proton' in data.keys():
...
#
      ...
      fig.savefig(to_path+'scatter_px_x_'+str(n).zfill(4)+'.png',format='png',dpi=80)
      plt.close("all")
      print(to_path+'scatter_px_x_'+str(n).zfill(4)+'.png')
