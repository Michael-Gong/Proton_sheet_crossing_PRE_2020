...
##end for norm colorbar####
  ...
  phi_est   = 12*a0**0.5/1836.0
  v_est     = (2*phi_est-phi_est**2)**0.5
  p_est     = 2*v_est/(1.0-v_est**2)
  En_est    = ((1+p_est**2)**0.5-1)*0.52*1836
...
#  plt.plot(a0,ek_reflec,'--',color='red',linewidth=4, label='Theoretic equation',zorder=0)
  plt.plot(a0,En_est,'--',color='red',linewidth=4, label='Theoretic equation',zorder=0)
  F = 0.0385*a0
...
#  plt.scatter(sim_a0,sim_ek_proton_sc,c='dodgerblue',marker='o',s=200, label='proton_sheet_cr', edgecolors='black', linewidth='2.5',alpha=1,zorder=1)
  ...
  fig.savefig('./wrap_proton_theory_ref2.png',format='png',dpi=160)
  plt.close("all")
